...
) -> Tuple[bool, Optional[bool]]:  # imgui.h:336
    pass

# IMGUI_API void          End();    /* original C++ signature */
def end() -> None:  # imgui.h:337
    pass
...
def set_next_window_size(size: ImVec2, cond: Cond = 0) -> None:  # imgui.h:368
...
def set_next_window_content_size(size: ImVec2) -> None:  # imgui.h:370
...
def set_next_window_collapsed(collapsed: bool, cond: Cond = 0) -> None:  # imgui.h:371
    """set next window collapsed state. call before Begin()"""
    pass

# IMGUI_API void          SetNextWindowFocus();                                                           /* original C++ signature */
def set_next_window_focus() -> None:  # imgui.h:372
    """set next window to be focused / top-most. call before Begin()"""
    pass

# IMGUI_API void          SetNextWindowScroll(const ImVec2& scroll);                                      /* original C++ signature */
def set_next_window_scroll(scroll: ImVec2) -> None:  # imgui.h:373
...
def set_window_collapsed(collapsed: bool, cond: Cond = 0) -> None:  # imgui.h:378
    """(not recommended) set current window collapsed state. prefer using SetNextWindowCollapsed()."""
    pass

# IMGUI_API void          SetWindowFocus();                                                               /* original C++ signature */
def set_window_focus() -> None:  # imgui.h:379
    """(not recommended) set current window to be focused / top-most. prefer using SetNextWindowFocus()."""
    pass

# IMGUI_API void          SetWindowFontScale(float scale);                                                /* original C++ signature */
def set_window_font_scale(scale: float) -> None:  # imgui.h:380
...
def set_window_pos(name: str, pos: ImVec2, cond: Cond = 0) -> None:  # imgui.h:381
    """set named window position."""
    pass

# IMGUI_API void          SetWindowSize(const char* name, const ImVec2& size, ImGuiCond cond = 0);        /* original C++ signature */
def set_window_size(name: str, size: ImVec2, cond: Cond = 0) -> None:  # imgui.h:382
...
def set_window_focus(name: str) -> None:  # imgui.h:384
...
def set_scroll_from_pos_x(
    local_x: float, center_x_ratio: float = 0.5
) -> None:  # imgui.h:405
...
def set_scroll_from_pos_y(
    local_y: float, center_y_ratio: float = 0.5
) -> None:  # imgui.h:406
    """adjust scrolling amount to make given position visible. Generally GetCursorStartPos() + offset to compute a valid position."""
    pass
...
def pop_item_width() -> None:  # imgui.h:424
    pass

# IMGUI_API void          SetNextItemWidth(float item_width);                                 /* original C++ signature */
def set_next_item_width(item_width: float) -> None:  # imgui.h:425
...
def label_text(label: str, fmt: str) -> None:  # imgui.h:501
    """display text+label aligned the same way as value+label widgets"""
    pass

# IMGUI_API void          BulletText(const char* fmt, ...)                                ;     /* original C++ signature */
def bullet_text(fmt: str) -> None:  # imgui.h:503
...
def small_button(label: str) -> bool:  # imgui.h:510
...
# IMGUI_API bool          ImageButton(const char* str_id, ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1));    /* original C++ signature */
def image_button(
    str_id: str,
    user_texture_id: ImTextureID,
    size: ImVec2,
...
def end_combo() -> None:  # imgui.h:530
...
def drag_float2(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:548
    pass
...
def drag_float3(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:549
    pass
...
def drag_float4(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:550
    pass
...
def drag_float_range2(
    ...
    flags: SliderFlags = 0,
) -> Tuple[bool, float, float]:  # imgui.h:551
    pass
...
def drag_int2(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:553
    pass
...
def drag_int3(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:554
    pass
...
def drag_int4(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:555
    pass
...
def drag_int_range2(
    ...
    format_max: Optional[str] = None,
    flags: SliderFlags = 0,
) -> Tuple[bool, int, int]:  # imgui.h:556
    pass
...
def slider_float2(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:567
    pass
...
def slider_float3(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:568
    pass
...
def slider_float4(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:569
    pass
...
def slider_int2(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:572
    pass
...
def slider_int3(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:573
    pass
...
def slider_int4(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:574
    pass
...
) -> Tuple[bool, List[float]]:  # imgui.h:588
    pass
...
def input_float3(
    label: str, v: List[float], format: str = "%.3", flags: InputTextFlags = 0
) -> Tuple[bool, List[float]]:  # imgui.h:589
    pass
...
def input_float4(
    label: str, v: List[float], format: str = "%.3", flags: InputTextFlags = 0
) -> Tuple[bool, List[float]]:  # imgui.h:590
    pass
...
) -> Tuple[bool, List[float]]:  # imgui.h:605
    pass
...
def set_color_edit_options(flags: ColorEditFlags) -> None:  # imgui.h:607
...
def collapsing_header(label: str, flags: TreeNodeFlags = 0) -> bool:  # imgui.h:625
...
def set_next_item_open(is_open: bool, cond: Cond = 0) -> None:  # imgui.h:627
...
def end_list_box() -> None:  # imgui.h:642
...
def begin_popup(str_id: str, flags: WindowFlags = 0) -> bool:  # imgui.h:693
...
def begin_popup_modal(
    name: str, p_open: Optional[bool] = None, flags: WindowFlags = 0
) -> Tuple[bool, Optional[bool]]:  # imgui.h:694
    """return True if the modal is open, and you can start outputting to it."""
    pass

# IMGUI_API void          EndPopup();                                                                             /* original C++ signature */
def end_popup() -> None:  # imgui.h:695
...
def open_popup(str_id: str, popup_flags: PopupFlags = 0) -> None:  # imgui.h:705
    """call to mark popup as open (don't call every frame!)."""
    pass

# IMGUI_API void          OpenPopup(ImGuiID id, ImGuiPopupFlags popup_flags = 0);                                 /* original C++ signature */
def open_popup(id_: ID, popup_flags: PopupFlags = 0) -> None:  # imgui.h:706
...
def close_current_popup() -> None:  # imgui.h:708
...
def is_popup_open(str_id: str, flags: PopupFlags = 0) -> bool:  # imgui.h:723
...
def end_table() -> None:  # imgui.h:749
...
def table_next_column() -> bool:  # imgui.h:751
    """append into the next column (or first column of next row if currently in last column). Return True when column is visible."""
    pass

# IMGUI_API bool          TableSetColumnIndex(int column_n);                      /* original C++ signature */
def table_set_column_index(column_n: int) -> bool:  # imgui.h:752
...
def table_setup_scroll_freeze(cols: int, rows: int) -> None:  # imgui.h:763
    """lock columns/rows so they stay visible when scrolled."""
    pass

# IMGUI_API void          TableHeadersRow();                                      /* original C++ signature */
def table_headers_row() -> None:  # imgui.h:764
    """submit all headers cells based on data provided to TableSetupColumn() + submit context menu"""
    pass

# IMGUI_API void          TableHeader(const char* label);                         /* original C++ signature */
def table_header(label: str) -> None:  # imgui.h:765
...
def table_get_sort_specs() -> TableSortSpecs:  # imgui.h:773
...
def log_to_tty(auto_open_depth: int = -1) -> None:  # imgui.h:824
...
def begin_drag_drop_source(flags: DragDropFlags = 0) -> bool:  # imgui.h:837
...
def end_drag_drop_source() -> None:  # imgui.h:839
    """only call EndDragDropSource() if BeginDragDropSource() returns True!"""
    pass

# IMGUI_API bool                  BeginDragDropTarget();                                                              /* original C++ signature */
def begin_drag_drop_target() -> bool:  # imgui.h:840
...
def end_drag_drop_target() -> None:  # imgui.h:842
    """only call EndDragDropTarget() if BeginDragDropTarget() returns True!"""
    pass

# IMGUI_API const ImGuiPayload*   GetDragDropPayload();                                                               /* original C++ signature */
def get_drag_drop_payload() -> Payload:  # imgui.h:843
...
def begin_disabled(disabled: bool = True) -> None:  # imgui.h:849
    pass

# IMGUI_API void          EndDisabled();    /* original C++ signature */
def end_disabled() -> None:  # imgui.h:850
    pass
...
def get_main_viewport() -> Viewport:  # imgui.h:887
...
def get_background_draw_list() -> ImDrawList:  # imgui.h:890
...
def get_foreground_draw_list() -> ImDrawList:  # imgui.h:891
...
def get_background_draw_list(viewport: Viewport) -> ImDrawList:  # imgui.h:892
...
def get_foreground_draw_list(viewport: Viewport) -> ImDrawList:  # imgui.h:893
...
def end_child_frame() -> None:  # imgui.h:905
...
def color_convert_u32_to_float4(in_: ImU32) -> ImVec4:  # imgui.h:911
    pass

# IMGUI_API ImU32         ColorConvertFloat4ToU32(const ImVec4& in);    /* original C++ signature */
def color_convert_float4_to_u32(in_: ImVec4) -> ImU32:  # imgui.h:912
    pass
...
) -> Tuple[float, float, float]:  # imgui.h:913
    pass
...
) -> Tuple[float, float, float]:  # imgui.h:914
    pass
...
def get_key_name(key: Key) -> str:  # imgui.h:926
...
def get_clipboard_text() -> str:  # imgui.h:952
    pass

# IMGUI_API void          SetClipboardText(const char* text);    /* original C++ signature */
def set_clipboard_text(text: str) -> None:  # imgui.h:953
    pass
...
def load_ini_settings_from_disk(ini_filename: str) -> None:  # imgui.h:959
...
def debug_text_encoding(text: str) -> None:  # imgui.h:965
    pass
...
class WindowFlags_(enum.Enum):  # imgui.h:995
...
class InputTextFlags_(enum.Enum):  # imgui.h:1036
...
class TreeNodeFlags_(enum.Enum):  # imgui.h:1068
    ...
    bullet = enum.auto()  # (= 1 << 9)  # Display a bullet instead of arrow
...
class PopupFlags_(enum.Enum):  # imgui.h:1097
...
class SelectableFlags_(enum.Enum):  # imgui.h:1113
...
class ComboFlags_(enum.Enum):  # imgui.h:1124
...
class TabBarFlags_(enum.Enum):  # imgui.h:1138
...
class TabItemFlags_(enum.Enum):  # imgui.h:1154
...
class TableFlags_(enum.Enum):  # imgui.h:1189
...
class TableColumnFlags_(enum.Enum):  # imgui.h:1240
...
class TableRowFlags_(enum.Enum):  # imgui.h:1277
...
class TableBgTarget_(enum.Enum):  # imgui.h:1292
...
class FocusedFlags_(enum.Enum):  # imgui.h:1301
...
class HoveredFlags_(enum.Enum):  # imgui.h:1315
    ...
    # ImGuiHoveredFlags_DelayNormal                   = 1 << 11,      /* original C++ signature */
    delay_normal = (
        enum.auto()
    )  # (= 1 << 11)  # Return True after io.HoverDelayNormal elapsed (~0.30 sec)
    # ImGuiHoveredFlags_DelayShort                    = 1 << 12,      /* original C++ signature */
    delay_short = (
        enum.auto()
    )  # (= 1 << 12)  # Return True after io.HoverDelayShort elapsed (~0.10 sec)
    # ImGuiHoveredFlags_NoSharedDelay                 = 1 << 13,      /* original C++ signature */
    no_shared_delay = (
        enum.auto()
    )  # (= 1 << 13)  # Disable shared delay system where moving from one item to the next keeps the previous timer for a short time (standard for tooltips with long delays)

class DockNodeFlags_(enum.Enum):  # imgui.h:1341
    ...
    keep_alive_only = (
        enum.auto()
    )  # (= 1 << 0)  # Shared       // Don't display the dockspace node but keep it alive. Windows docked into this dockspace node won't be undocked.
    ...
    passthru_central_node = (
        enum.auto()
    )  # (= 1 << 3)  # Shared       // Enable passthru dockspace: 1) DockSpace() will render a ImGuiCol_WindowBg background covering everything excepted the Central Node when empty. Meaning the host window should probably use SetNextWindowBgAlpha(0.0) prior to Begin() when using this. 2) When Central Node is empty: let inputs pass-through + won't display a DockingEmptyBg background. See demo for details.
    # ImGuiDockNodeFlags_NoSplit                      = 1 << 4,       /* original C++ signature */
    no_split = (
        enum.auto()
    )  # (= 1 << 4)  # Shared/Local // Disable splitting the node into smaller nodes. Useful e.g. when embedding dockspaces into a main root one (the root one may have splitting disabled to reduce confusion). Note: when turned off, existing splits will be preserved.
    # ImGuiDockNodeFlags_NoResize                     = 1 << 5,       /* original C++ signature */
    no_resize = (
        enum.auto()
    )  # (= 1 << 5)  # Shared/Local // Disable resizing node using the splitter/separators. Useful with programmatically setup dockspaces.
...
class DragDropFlags_(enum.Enum):  # imgui.h:1354
    ...
    source_no_preview_tooltip = (
        enum.auto()
    )  # (= 1 << 0)  # By default, a successful call to BeginDragDropSource opens a tooltip so you can display a preview or description of the source contents. This flag disables this behavior.
...
class DataType_(enum.Enum):  # imgui.h:1376
    """A primary data type"""
...
class Dir_(enum.Enum):  # imgui.h:1392
...
class SortDirection_(enum.Enum):  # imgui.h:1403
    """A sorting direction"""
...
class Key(enum.Enum):  # imgui.h:1413
    ...
    gamepad_start = (
        enum.auto()
    )  # (= 617)  # Menu (Xbox)      + (Switch)   Start/Options (PS)
    # ImGuiKey_GamepadBack,               /* original C++ signature */
    gamepad_back = enum.auto()  # (= 618)  # View (Xbox)      - (Switch)   Share (PS)
    # ImGuiKey_GamepadFaceLeft,           /* original C++ signature */
    gamepad_face_left = (
        enum.auto()
    )  # (= 619)  # X (Xbox)         Y (Switch)   Square (PS)        // Tap: Toggle Menu. Hold: Windowing mode (Focus/Move/Resize windows)
    # ImGuiKey_GamepadFaceRight,          /* original C++ signature */
    gamepad_face_right = (
        enum.auto()
    )  # (= 620)  # B (Xbox)         A (Switch)   Circle (PS)        // Cancel / Close / Exit
    # ImGuiKey_GamepadFaceUp,             /* original C++ signature */
    gamepad_face_up = (
        enum.auto()
    )  # (= 621)  # Y (Xbox)         X (Switch)   Triangle (PS)      // Text Input / On-screen Keyboard
    # ImGuiKey_GamepadFaceDown,           /* original C++ signature */
    gamepad_face_down = (
        enum.auto()
    )  # (= 622)  # A (Xbox)         B (Switch)   Cross (PS)         // Activate / Open / Toggle / Tweak
    # ImGuiKey_GamepadDpadLeft,           /* original C++ signature */
    gamepad_dpad_left = (
        enum.auto()
    )  # (= 623)  # D-pad Left                                       // Move / Tweak / Resize Window (in Windowing mode)
    # ImGuiKey_GamepadDpadRight,          /* original C++ signature */
    gamepad_dpad_right = (
        enum.auto()
    )  # (= 624)  # D-pad Right                                      // Move / Tweak / Resize Window (in Windowing mode)
    # ImGuiKey_GamepadDpadUp,             /* original C++ signature */
    gamepad_dpad_up = (
        enum.auto()
    )  # (= 625)  # D-pad Up                                         // Move / Tweak / Resize Window (in Windowing mode)
    # ImGuiKey_GamepadDpadDown,           /* original C++ signature */
    gamepad_dpad_down = (
        enum.auto()
    )  # (= 626)  # D-pad Down                                       // Move / Tweak / Resize Window (in Windowing mode)
    # ImGuiKey_GamepadL1,                 /* original C++ signature */
    gamepad_l1 = (
        enum.auto()
    )  # (= 627)  # L Bumper (Xbox)  L (Switch)   L1 (PS)            // Tweak Slower / Focus Previous (in Windowing mode)
    # ImGuiKey_GamepadR1,                 /* original C++ signature */
    gamepad_r1 = (
        enum.auto()
    )  # (= 628)  # R Bumper (Xbox)  R (Switch)   R1 (PS)            // Tweak Faster / Focus Next (in Windowing mode)
    # ImGuiKey_GamepadL2,                 /* original C++ signature */
    gamepad_l2 = (
        enum.auto()
    )  # (= 629)  # L Trig. (Xbox)   ZL (Switch)  L2 (PS) [Analog]
    # ImGuiKey_GamepadR2,                 /* original C++ signature */
    gamepad_r2 = (
        enum.auto()
    )  # (= 630)  # R Trig. (Xbox)   ZR (Switch)  R2 (PS) [Analog]
    # ImGuiKey_GamepadL3,                 /* original C++ signature */
    gamepad_l3 = enum.auto()  # (= 631)  # L Stick (Xbox)   L3 (Switch)  L3 (PS)
    # ImGuiKey_GamepadR3,                 /* original C++ signature */
    gamepad_r3 = enum.auto()  # (= 632)  # R Stick (Xbox)   R3 (Switch)  R3 (PS)
    # ImGuiKey_GamepadLStickLeft,         /* original C++ signature */
    gamepad_l_stick_left = (
        enum.auto()
    )  # (= 633)  # [Analog]                                         // Move Window (in Windowing mode)
    # ImGuiKey_GamepadLStickRight,        /* original C++ signature */
    gamepad_l_stick_right = (
        enum.auto()
    )  # (= 634)  # [Analog]                                         // Move Window (in Windowing mode)
    # ImGuiKey_GamepadLStickUp,           /* original C++ signature */
    gamepad_l_stick_up = (
        enum.auto()
    )  # (= 635)  # [Analog]                                         // Move Window (in Windowing mode)
    # ImGuiKey_GamepadLStickDown,         /* original C++ signature */
    gamepad_l_stick_down = (
        enum.auto()
    )  # (= 636)  # [Analog]                                         // Move Window (in Windowing mode)
    # ImGuiKey_GamepadRStickLeft,         /* original C++ signature */
    gamepad_r_stick_left = enum.auto()  # (= 637)  # [Analog]
    # ImGuiKey_GamepadRStickRight,        /* original C++ signature */
    gamepad_r_stick_right = enum.auto()  # (= 638)  # [Analog]
    # ImGuiKey_GamepadRStickUp,           /* original C++ signature */
    gamepad_r_stick_up = enum.auto()  # (= 639)  # [Analog]
    # ImGuiKey_GamepadRStickDown,         /* original C++ signature */
    gamepad_r_stick_down = enum.auto()  # (= 640)  # [Analog]
    ...
    im_gui_mod_ctrl = enum.auto()  # (= 1 << 12)
    # ImGuiMod_Shift                  = 1 << 13,    /* original C++ signature */
    im_gui_mod_shift = enum.auto()  # (= 1 << 13)
    ...
    im_gui_mod_mask_ = enum.auto()  # (= 0xF000)
...
class ConfigFlags_(enum.Enum):  # imgui.h:1554
...
class BackendFlags_(enum.Enum):  # imgui.h:1579
...
class Col_(enum.Enum):  # imgui.h:1594
...
class StyleVar_(enum.Enum):  # imgui.h:1661
    ...
    button_text_align = enum.auto()  # (= 23)  # ImVec2    ButtonTextAlign
    # ImGuiStyleVar_SelectableTextAlign,     /* original C++ signature */
    selectable_text_align = enum.auto()  # (= 24)  # ImVec2    SelectableTextAlign
    # ImGuiStyleVar_COUNT    /* original C++ signature */
    # }
    count = enum.auto()  # (= 25)

class ButtonFlags_(enum.Enum):  # imgui.h:1693
...
class ColorEditFlags_(enum.Enum):  # imgui.h:1706
...
class SliderFlags_(enum.Enum):  # imgui.h:1752
...
class MouseButton_(enum.Enum):  # imgui.h:1769
...
class MouseCursor_(enum.Enum):  # imgui.h:1779
...
class Cond_(enum.Enum):  # imgui.h:1797
...
class ImNewWrapper:  # imgui.h:1816
...
class Style:  # imgui.h:1909
    # float       Alpha;    /* original C++ signature */
    alpha: float  # Global alpha applies to everything in Dear ImGui.    # imgui.h:1911
    # float       DisabledAlpha;    /* original C++ signature */
    disabled_alpha: float  # Additional alpha multiplier applied by BeginDisabled(). Multiply over current value of Alpha.    # imgui.h:1912
    # ImVec2      WindowPadding;    /* original C++ signature */
    window_padding: ImVec2  # Padding within a window.    # imgui.h:1913
    # float       WindowRounding;    /* original C++ signature */
    window_rounding: float  # Radius of window corners rounding. Set to 0.0 to have rectangular windows. Large values tend to lead to variety of artifacts and are not recommended.    # imgui.h:1914
    # float       WindowBorderSize;    /* original C++ signature */
    window_border_size: float  # Thickness of border around windows. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1915
    # ImVec2      WindowMinSize;    /* original C++ signature */
    window_min_size: ImVec2  # Minimum window size. This is a global setting. If you want to constrain individual windows, use SetNextWindowSizeConstraints().    # imgui.h:1916
    # ImVec2      WindowTitleAlign;    /* original C++ signature */
    window_title_align: ImVec2  # Alignment for title bar text. Defaults to (0.0,0.5) for left-aligned,vertically centered.    # imgui.h:1917
    # ImGuiDir    WindowMenuButtonPosition;    /* original C++ signature */
    window_menu_button_position: Dir  # Side of the collapsing/docking button in the title bar (None/Left/Right). Defaults to ImGuiDir_Left.    # imgui.h:1918
    # float       ChildRounding;    /* original C++ signature */
    child_rounding: float  # Radius of child window corners rounding. Set to 0.0 to have rectangular windows.    # imgui.h:1919
    # float       ChildBorderSize;    /* original C++ signature */
    child_border_size: float  # Thickness of border around child windows. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1920
    # float       PopupRounding;    /* original C++ signature */
    popup_rounding: float  # Radius of popup window corners rounding. (Note that tooltip windows use WindowRounding)    # imgui.h:1921
    # float       PopupBorderSize;    /* original C++ signature */
    popup_border_size: float  # Thickness of border around popup/tooltip windows. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1922
    # ImVec2      FramePadding;    /* original C++ signature */
    frame_padding: ImVec2  # Padding within a framed rectangle (used by most widgets).    # imgui.h:1923
    # float       FrameRounding;    /* original C++ signature */
    frame_rounding: float  # Radius of frame corners rounding. Set to 0.0 to have rectangular frame (used by most widgets).    # imgui.h:1924
    # float       FrameBorderSize;    /* original C++ signature */
    frame_border_size: float  # Thickness of border around frames. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1925
    # ImVec2      ItemSpacing;    /* original C++ signature */
    item_spacing: ImVec2  # Horizontal and vertical spacing between widgets/lines.    # imgui.h:1926
    # ImVec2      ItemInnerSpacing;    /* original C++ signature */
    item_inner_spacing: ImVec2  # Horizontal and vertical spacing between within elements of a composed widget (e.g. a slider and its label).    # imgui.h:1927
    # ImVec2      CellPadding;    /* original C++ signature */
    cell_padding: ImVec2  # Padding within a table cell    # imgui.h:1928
    # ImVec2      TouchExtraPadding;    /* original C++ signature */
    touch_extra_padding: ImVec2  # Expand reactive bounding box for touch-based system where touch position is not accurate enough. Unfortunately we don't sort widgets so priority on overlap will always be given to the first widget. So don't grow this too much!    # imgui.h:1929
    # float       IndentSpacing;    /* original C++ signature */
    indent_spacing: float  # Horizontal indentation when e.g. entering a tree node. Generally == (FontSize + FramePadding.x*2).    # imgui.h:1930
    # float       ColumnsMinSpacing;    /* original C++ signature */
    columns_min_spacing: float  # Minimum horizontal spacing between two columns. Preferably > (FramePadding.x + 1).    # imgui.h:1931
    # float       ScrollbarSize;    /* original C++ signature */
    scrollbar_size: float  # Width of the vertical scrollbar, Height of the horizontal scrollbar.    # imgui.h:1932
    # float       ScrollbarRounding;    /* original C++ signature */
    scrollbar_rounding: float  # Radius of grab corners for scrollbar.    # imgui.h:1933
    # float       GrabMinSize;    /* original C++ signature */
    grab_min_size: float  # Minimum width/height of a grab box for slider/scrollbar.    # imgui.h:1934
    # float       GrabRounding;    /* original C++ signature */
    grab_rounding: float  # Radius of grabs corners rounding. Set to 0.0 to have rectangular slider grabs.    # imgui.h:1935
    # float       LogSliderDeadzone;    /* original C++ signature */
    log_slider_deadzone: float  # The size in pixels of the dead-zone around zero on logarithmic sliders that cross zero.    # imgui.h:1936
    # float       TabRounding;    /* original C++ signature */
    tab_rounding: float  # Radius of upper corners of a tab. Set to 0.0 to have rectangular tabs.    # imgui.h:1937
    # float       TabBorderSize;    /* original C++ signature */
    tab_border_size: float  # Thickness of border around tabs.    # imgui.h:1938
    # float       TabMinWidthForCloseButton;    /* original C++ signature */
    tab_min_width_for_close_button: float  # Minimum width for close button to appear on an unselected tab when hovered. Set to 0.0 to always show when hovering, set to FLT_MAX to never show close button unless selected.    # imgui.h:1939
    # ImGuiDir    ColorButtonPosition;    /* original C++ signature */
    color_button_position: Dir  # Side of the color button in the ColorEdit4 widget (left/right). Defaults to ImGuiDir_Right.    # imgui.h:1940
    # ImVec2      ButtonTextAlign;    /* original C++ signature */
    button_text_align: ImVec2  # Alignment of button text when button is larger than text. Defaults to (0.5, 0.5) (centered).    # imgui.h:1941
    # ImVec2      SelectableTextAlign;    /* original C++ signature */
    selectable_text_align: ImVec2  # Alignment of selectable text. Defaults to (0.0, 0.0) (top-left aligned). It's generally important to keep this left-aligned if you want to lay multiple items on a same line.    # imgui.h:1942
    # ImVec2      DisplayWindowPadding;    /* original C++ signature */
    display_window_padding: ImVec2  # Window position are clamped to be visible within the display area or monitors by at least this amount. Only applies to regular windows.    # imgui.h:1943
    # ImVec2      DisplaySafeAreaPadding;    /* original C++ signature */
    display_safe_area_padding: ImVec2  # If you cannot see the edges of your screen (e.g. on a TV) increase the safe area padding. Apply to popups/tooltips as well regular windows. NB: Prefer configuring your TV sets correctly!    # imgui.h:1944
    # float       MouseCursorScale;    /* original C++ signature */
    mouse_cursor_scale: float  # Scale software rendered mouse cursor (when io.MouseDrawCursor is enabled). We apply per-monitor DPI scaling over this scale. May be removed later.    # imgui.h:1945
    # bool        AntiAliasedLines;    /* original C++ signature */
    anti_aliased_lines: bool  # Enable anti-aliased lines/borders. Disable if you are really tight on CPU/GPU. Latched at the beginning of the frame (copied to ImDrawList).    # imgui.h:1946
    # bool        AntiAliasedLinesUseTex;    /* original C++ signature */
    anti_aliased_lines_use_tex: bool  # Enable anti-aliased lines/borders using textures where possible. Require backend to render with bilinear filtering (NOT point/nearest filtering). Latched at the beginning of the frame (copied to ImDrawList).    # imgui.h:1947
    # bool        AntiAliasedFill;    /* original C++ signature */
    anti_aliased_fill: bool  # Enable anti-aliased edges around filled shapes (rounded rectangles, circles, etc.). Disable if you are really tight on CPU/GPU. Latched at the beginning of the frame (copied to ImDrawList).    # imgui.h:1948
    # float       CurveTessellationTol;    /* original C++ signature */
    curve_tessellation_tol: float  # Tessellation tolerance when using PathBezierCurveTo() without a specific number of segments. Decrease for highly tessellated curves (higher quality, more polygons), increase to reduce quality.    # imgui.h:1949
    # float       CircleTessellationMaxError;    /* original C++ signature */
    circle_tessellation_max_error: float  # Maximum error (in pixels) allowed when using AddCircle()/AddCircleFilled() or drawing rounded corner rectangles with no explicit segment count specified. Decrease for higher quality but more geometry.    # imgui.h:1950

    # IMGUI_API ImGuiStyle();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:1953
        pass
    # IMGUI_API void ScaleAllSizes(float scale_factor);    /* original C++ signature */
    def scale_all_sizes(self, scale_factor: float) -> None:  # imgui.h:1954
        pass
...
class KeyData:  # imgui.h:1966
    """[Internal] Storage used by IsKeyDown(), IsKeyPressed() etc functions.
    If prior to 1.87 you used io.KeysDownDuration[] (which was marked as internal), you should use GetKeyData(key)->DownDuration and *NOT* io.KeysData[key]->DownDuration.
    """

    # bool        Down;    /* original C++ signature */
    down: bool  # True for if key is down    # imgui.h:1968
    # float       DownDuration;    /* original C++ signature */
    down_duration: float  # Duration the key has been down (<0.0: not pressed, 0.0: just pressed, >0.0: time held)    # imgui.h:1969
    # float       DownDurationPrev;    /* original C++ signature */
    down_duration_prev: float  # Last frame duration the key has been down    # imgui.h:1970
    # float       AnalogValue;    /* original C++ signature */
    analog_value: float  # 0.0..1.0 for gamepad values    # imgui.h:1971
...
class IO:  # imgui.h:1974
    # ------------------------------------------------------------------
    # Configuration                            // Default value
    # ------------------------------------------------------------------

    # ImGuiConfigFlags   ConfigFlags;    /* original C++ signature */
    config_flags: ConfigFlags  # = 0              // See ImGuiConfigFlags_ enum. Set by user/application. Gamepad/keyboard navigation options, etc.    # imgui.h:1980
    # ImGuiBackendFlags  BackendFlags;    /* original C++ signature */
    backend_flags: BackendFlags  # = 0              // See ImGuiBackendFlags_ enum. Set by backend (imgui_impl_xxx files or custom backend) to communicate features supported by the backend.    # imgui.h:1981
    # ImVec2      DisplaySize;    /* original C++ signature */
    display_size: ImVec2  # <unset>          // Main display size, in pixels (generally == GetMainViewport()->Size). May change every frame.    # imgui.h:1982
    # float       DeltaTime;    /* original C++ signature */
    delta_time: float  # = 1.0/60.0     // Time elapsed since last frame, in seconds. May change every frame.    # imgui.h:1983
    # float       IniSavingRate;    /* original C++ signature */
    ini_saving_rate: float  # = 5.0           // Minimum time between saving positions/sizes to .ini file, in seconds.    # imgui.h:1984
    # const char* IniFilename;    /* original C++ signature */
    ini_filename: str  # = "imgui.ini"    // Path to .ini file (important: default "imgui.ini" is relative to current working dir!). Set None to disable automatic .ini loading/saving or if you want to manually call LoadIniSettingsXXX() / SaveIniSettingsXXX() functions.    # imgui.h:1985
    # const char* LogFilename;    /* original C++ signature */
    log_filename: str  # = "imgui_log.txt"// Path to .log file (default parameter to ImGui::LogToFile when no file is specified).    # imgui.h:1986
    # float       MouseDoubleClickTime;    /* original C++ signature */
    mouse_double_click_time: float  # = 0.30          // Time for a double-click, in seconds.    # imgui.h:1987
    # float       MouseDoubleClickMaxDist;    /* original C++ signature */
    mouse_double_click_max_dist: float  # = 6.0           // Distance threshold to stay in to validate a double-click, in pixels.    # imgui.h:1988
    # float       MouseDragThreshold;    /* original C++ signature */
    mouse_drag_threshold: float  # = 6.0           // Distance threshold before considering we are dragging.    # imgui.h:1989
    # float       KeyRepeatDelay;    /* original C++ signature */
    key_repeat_delay: float  # = 0.275         // When holding a key/button, time before it starts repeating, in seconds (for buttons in Repeat mode, etc.).    # imgui.h:1990
    # float       KeyRepeatRate;    /* original C++ signature */
    key_repeat_rate: float  # = 0.050         // When holding a key/button, rate at which it repeats, in seconds.    # imgui.h:1991
    # float       HoverDelayNormal;    /* original C++ signature */
    hover_delay_normal: float  # = 0.30 sec       // Delay on hovering before IsItemHovered(ImGuiHoveredFlags_DelayNormal) returns True.    # imgui.h:1992
    # float       HoverDelayShort;    /* original C++ signature */
    hover_delay_short: float  # = 0.10 sec       // Delay on hovering before IsItemHovered(ImGuiHoveredFlags_DelayShort) returns True.    # imgui.h:1993
    # void*       UserData;    /* original C++ signature */
    user_data: Any  # = None           // Store your own data for retrieval by callbacks.    # imgui.h:1994

    # ImFontAtlas*Fonts;    /* original C++ signature */
    fonts: ImFontAtlas  # <auto>           // Font atlas: load, rasterize and pack one or more fonts into a single texture.    # imgui.h:1996
    # float       FontGlobalScale;    /* original C++ signature */
    font_global_scale: float  # = 1.0           // Global scale all fonts    # imgui.h:1997
    # bool        FontAllowUserScaling;    /* original C++ signature */
    font_allow_user_scaling: bool  # = False          // Allow user scaling text of individual window with CTRL+Wheel.    # imgui.h:1998
    # ImFont*     FontDefault;    /* original C++ signature */
    font_default: ImFont  # = None           // Font to use on NewFrame(). Use None to uses Fonts->Fonts[0].    # imgui.h:1999
    # ImVec2      DisplayFramebufferScale;    /* original C++ signature */
    display_framebuffer_scale: ImVec2  # = (1, 1)         // For retina display or other situations where window coordinates are different from framebuffer coordinates. This generally ends up in ImDrawData::FramebufferScale.    # imgui.h:2000

    # Docking options (when ImGuiConfigFlags_DockingEnable is set)
    # bool        ConfigDockingNoSplit;    /* original C++ signature */
    config_docking_no_split: bool  # = False          // Simplified docking mode: disable window splitting, so docking is limited to merging multiple windows together into tab-bars.    # imgui.h:2003
    # bool        ConfigDockingWithShift;    /* original C++ signature */
    config_docking_with_shift: bool  # = False          // Enable docking with holding Shift key (reduce visual noise, allows dropping in wider space)    # imgui.h:2004
    # bool        ConfigDockingAlwaysTabBar;    /* original C++ signature */
    config_docking_always_tab_bar: bool  # = False          // [BETA] [FIXME: This currently creates regression with auto-sizing and general overhead] Make every single floating window display within a docking node.    # imgui.h:2005
    # bool        ConfigDockingTransparentPayload;    /* original C++ signature */
    config_docking_transparent_payload: bool  # = False          // [BETA] Make window or viewport transparent when docking and only display docking boxes on the target viewport. Useful if rendering of multiple viewport cannot be synced. Best used with ConfigViewportsNoAutoMerge.    # imgui.h:2006

    # Viewport options (when ImGuiConfigFlags_ViewportsEnable is set)
    # bool        ConfigViewportsNoAutoMerge;    /* original C++ signature */
    config_viewports_no_auto_merge: bool  # = False;         // Set to make all floating imgui windows always create their own viewport. Otherwise, they are merged into the main host viewports when overlapping it. May also set ImGuiViewportFlags_NoAutoMerge on individual viewport.    # imgui.h:2009
    # bool        ConfigViewportsNoTaskBarIcon;    /* original C++ signature */
    config_viewports_no_task_bar_icon: bool  # = False          // Disable default OS task bar icon flag for secondary viewports. When a viewport doesn't want a task bar icon, ImGuiViewportFlags_NoTaskBarIcon will be set on it.    # imgui.h:2010
    ...
    mouse_draw_cursor: bool  # = False          // Request ImGui to draw a mouse cursor for you (if you are on a platform without a mouse cursor). Cannot be easily renamed to 'io.ConfigXXX' because this is frequently used by backend implementations.    # imgui.h:2015
    ...
    config_input_trickle_event_queue: bool  # = True           // Enable input queue trickling: some types of events submitted during the same frame (e.g. button down + up) will be spread over multiple frames, improving interactions with low framerates.    # imgui.h:2017
    # bool        ConfigInputTextCursorBlink;    /* original C++ signature */
    config_input_text_cursor_blink: bool  # = True           // Enable blinking cursor (optional as some users consider it to be distracting).    # imgui.h:2018
    # bool        ConfigInputTextEnterKeepActive;    /* original C++ signature */
    config_input_text_enter_keep_active: bool  # = False          // [BETA] Pressing Enter will keep item active and select contents (single-line only).    # imgui.h:2019
    # bool        ConfigDragClickToInputText;    /* original C++ signature */
    config_drag_click_to_input_text: bool  # = False          // [BETA] Enable turning DragXXX widgets into text input with a simple mouse click-release (without moving). Not desirable on devices without a keyboard.    # imgui.h:2020
    ...
    config_windows_move_from_title_bar_only: bool  # = False       // Enable allowing to move windows only when clicking on their title bar. Does not apply to windows without a title bar.    # imgui.h:2022
    # float       ConfigMemoryCompactTimer;    /* original C++ signature */
    config_memory_compact_timer: float  # = 60.0          // Timer (in seconds) to free transient windows/tables memory buffers when unused. Set to -1.0 to disable.    # imgui.h:2023
    ...
    backend_platform_name: str  # = None    # imgui.h:2031
    # const char* BackendRendererName;    /* original C++ signature */
    backend_renderer_name: str  # = None    # imgui.h:2032
    # void*       BackendPlatformUserData;    /* original C++ signature */
    backend_platform_user_data: Any  # = None           // User data for platform backend    # imgui.h:2033
    # void*       BackendRendererUserData;    /* original C++ signature */
    backend_renderer_user_data: Any  # = None           // User data for renderer backend    # imgui.h:2034
    # void*       BackendLanguageUserData;    /* original C++ signature */
    backend_language_user_data: Any  # = None           // User data for non C++ programming language backend    # imgui.h:2035

    # Optional: Access OS clipboard
    # (default to use native Win32 clipboard on Windows, otherwise uses a private clipboard. Override to access OS clipboard on other architectures)
    # void*       ClipboardUserData;    /* original C++ signature */
    clipboard_user_data: Any  # imgui.h:2041
    ...
    def add_key_event(self, key: Key, down: bool) -> None:  # imgui.h:2057
    ...
    def set_app_accepting_events(self, accepting_events: bool) -> None:  # imgui.h:2069
        """Set master flag for accepting key/mouse/text events (default to True). Useful if you have native dialog boxes that are interrupting your application loop/refresh, and you want to disable events being queued while your app is frozen."""
        pass
    # IMGUI_API void  ClearInputCharacters();                                     /* original C++ signature */
    def clear_input_characters(self) -> None:  # imgui.h:2070
        """[Internal] Clear the text input buffer manually"""
        pass
    # IMGUI_API void  ClearInputKeys();                                           /* original C++ signature */
    def clear_input_keys(self) -> None:  # imgui.h:2071
    ...
    want_capture_keyboard: bool  # Set when Dear ImGui will use keyboard inputs, in this case do not dispatch them to your main game/application (either way, always pass keyboard inputs to imgui). (e.g. InputText active, or an imgui window is focused and navigation is enabled, etc.).    # imgui.h:2080
    # bool        WantTextInput;    /* original C++ signature */
    want_text_input: bool  # Mobile/console: when set, you may display an on-screen keyboard. This is set by Dear ImGui when it wants textual keyboard input to happen (e.g. when a InputText widget is active).    # imgui.h:2081
    # bool        WantSetMousePos;    /* original C++ signature */
    want_set_mouse_pos: bool  # MousePos has been altered, backend should reposition mouse on next frame. Rarely used! Set only when ImGuiConfigFlags_NavEnableSetMousePos flag is enabled.    # imgui.h:2082
    # bool        WantSaveIniSettings;    /* original C++ signature */
    want_save_ini_settings: bool  # When manual .ini load/save is active (io.IniFilename == None), this will be set to notify your application that you can call SaveIniSettingsToMemory() and save yourself. Important: clear io.WantSaveIniSettings yourself after saving!    # imgui.h:2083
    # bool        NavActive;    /* original C++ signature */
    nav_active: bool  # Keyboard/Gamepad navigation is currently allowed (will handle ImGuiKey_NavXXX events) = a window is focused and it doesn't use the ImGuiWindowFlags_NoNavInputs flag.    # imgui.h:2084
    # bool        NavVisible;    /* original C++ signature */
    nav_visible: bool  # Keyboard/Gamepad navigation is visible and allowed (will handle ImGuiKey_NavXXX events).    # imgui.h:2085
    # float       Framerate;    /* original C++ signature */
    framerate: float  # Estimate of application framerate (rolling average over 60 frames, based on io.DeltaTime), in frame per second. Solely for convenience. Slow applications may not want to use a moving average or may want to reset underlying buffers occasionally.    # imgui.h:2086
    # int         MetricsRenderVertices;    /* original C++ signature */
    metrics_render_vertices: int  # Vertices output during last call to Render()    # imgui.h:2087
    # int         MetricsRenderIndices;    /* original C++ signature */
    metrics_render_indices: int  # Indices output during last call to Render() = number of triangles * 3    # imgui.h:2088
    # int         MetricsRenderWindows;    /* original C++ signature */
    metrics_render_windows: int  # Number of visible windows    # imgui.h:2089
    # int         MetricsActiveWindows;    /* original C++ signature */
    metrics_active_windows: int  # Number of active windows    # imgui.h:2090
    # int         MetricsActiveAllocations;    /* original C++ signature */
    metrics_active_allocations: int  # Number of active allocations, updated by MemAlloc/MemFree based on current context. May be off if you have multiple imgui contexts.    # imgui.h:2091
    # ImVec2      MouseDelta;    /* original C++ signature */
    mouse_delta: ImVec2  # imgui.h:2092
    ...
    mouse_pos: ImVec2  # Mouse position, in pixels. Set to ImVec2(-FLT_MAX, -FLT_MAX) if mouse is unavailable (on another screen, etc.)    # imgui.h:2110
    ...
    mouse_wheel: float  # Mouse wheel Vertical: 1 unit scrolls about 5 lines text.    # imgui.h:2112
    # float       MouseWheelH;    /* original C++ signature */
    mouse_wheel_h: float  # Mouse wheel Horizontal. Most users don't have a mouse with a horizontal wheel, may not be filled by all backends.    # imgui.h:2113
    ...
    key_ctrl: bool  # Keyboard modifier down: Control    # imgui.h:2115
    # bool        KeyShift;    /* original C++ signature */
    key_shift: bool  # Keyboard modifier down: Shift    # imgui.h:2116
    # bool        KeyAlt;    /* original C++ signature */
    key_alt: bool  # Keyboard modifier down: Alt    # imgui.h:2117
    # bool        KeySuper;    /* original C++ signature */
    key_super: bool  # Keyboard modifier down: Cmd/Super/Windows    # imgui.h:2118

    # Other state maintained from data above + IO function calls
    # ImGuiKeyChord KeyMods;    /* original C++ signature */
    key_mods: KeyChord  # Key mods flags (any of ImGuiMod_Ctrl/ImGuiMod_Shift/ImGuiMod_Alt/ImGuiMod_Super flags, same as io.KeyCtrl/KeyShift/KeyAlt/KeySuper but merged into flags). Read-only, updated by NewFrame()    # imgui.h:2121
    # bool        WantCaptureMouseUnlessPopupClose;    /* original C++ signature */
    want_capture_mouse_unless_popup_close: bool  # Alternative to WantCaptureMouse: (WantCaptureMouse == True && WantCaptureMouseUnlessPopupClose == False) when a click over None is expected to close a popup.    # imgui.h:2123
    # ImVec2      MousePosPrev;    /* original C++ signature */
    mouse_pos_prev: ImVec2  # Previous mouse position (note that MouseDelta is not necessary == MousePos-MousePosPrev, in case either position is invalid)    # imgui.h:2124
    # double      MouseClickedTime[5];    /* original C++ signature */
    mouse_clicked_time: np.ndarray  # ndarray[type=double, size=5]  # Time of last click (used to figure out double-click)    # imgui.h:2126
    # bool        MouseClicked[5];    /* original C++ signature */
    mouse_clicked: np.ndarray  # ndarray[type=bool, size=5]  # Mouse button went from !Down to Down (same as MouseClickedCount[x] != 0)    # imgui.h:2127
    # bool        MouseDoubleClicked[5];    /* original C++ signature */
    mouse_double_clicked: np.ndarray  # ndarray[type=bool, size=5]  # Has mouse button been double-clicked? (same as MouseClickedCount[x] == 2)    # imgui.h:2128
    # ImU16       MouseClickedCount[5];    /* original C++ signature */
    mouse_clicked_count: np.ndarray  # ndarray[type=ImU16, size=5]  # == 0 (not clicked), == 1 (same as MouseClicked[]), == 2 (double-clicked), == 3 (triple-clicked) etc. when going from !Down to Down    # imgui.h:2129
    # ImU16       MouseClickedLastCount[5];    /* original C++ signature */
    mouse_clicked_last_count: np.ndarray  # ndarray[type=ImU16, size=5]  # Count successive number of clicks. Stays valid after mouse release. Reset after another click is done.    # imgui.h:2130
    # bool        MouseReleased[5];    /* original C++ signature */
    mouse_released: np.ndarray  # ndarray[type=bool, size=5]  # Mouse button went from Down to !Down    # imgui.h:2131
    # bool        MouseDownOwned[5];    /* original C++ signature */
    mouse_down_owned: np.ndarray  # ndarray[type=bool, size=5]  # Track if button was clicked inside a dear imgui window or over None blocked by a popup. We don't request mouse capture from the application if click started outside ImGui bounds.    # imgui.h:2132
    # bool        MouseDownOwnedUnlessPopupClose[5];    /* original C++ signature */
    mouse_down_owned_unless_popup_close: np.ndarray  # ndarray[type=bool, size=5]  # Track if button was clicked inside a dear imgui window.    # imgui.h:2133
    # float       MouseDownDuration[5];    /* original C++ signature */
    mouse_down_duration: np.ndarray  # ndarray[type=float, size=5]  # Duration the mouse button has been down (0.0 == just clicked)    # imgui.h:2134
    # float       MouseDownDurationPrev[5];    /* original C++ signature */
    mouse_down_duration_prev: np.ndarray  # ndarray[type=float, size=5]  # Previous time the mouse button has been down    # imgui.h:2135
    # float       MouseDragMaxDistanceSqr[5];    /* original C++ signature */
    mouse_drag_max_distance_sqr: np.ndarray  # ndarray[type=float, size=5]  # Squared maximum distance of how much mouse has traveled from the clicking point (used for moving thresholds)    # imgui.h:2137
    # float       PenPressure;    /* original C++ signature */
    pen_pressure: float  # Touch/Pen pressure (0.0 to 1.0, should be >0.0 only when MouseDown[0] == True). Helper storage currently unused by Dear ImGui.    # imgui.h:2138
    # bool        AppFocusLost;    /* original C++ signature */
    app_focus_lost: bool  # Only modify via AddFocusEvent()    # imgui.h:2139
    # bool        AppAcceptingEvents;    /* original C++ signature */
    app_accepting_events: bool  # Only modify via SetAppAcceptingEvents()    # imgui.h:2140
    # ImS8        BackendUsingLegacyKeyArrays;    /* original C++ signature */
    backend_using_legacy_key_arrays: ImS8  # -1: unknown, 0: using AddKeyEvent(), 1: using legacy io.KeysDown[]    # imgui.h:2141
    # bool        BackendUsingLegacyNavInputArray;    /* original C++ signature */
    backend_using_legacy_nav_input_array: bool  # 0: using AddKeyAnalogEvent(), 1: writing to legacy io.NavInputs[] directly    # imgui.h:2142
    # ImWchar16   InputQueueSurrogate;    /* original C++ signature */
    input_queue_surrogate: ImWchar16  # For AddInputCharacterUTF16()    # imgui.h:2143

    # IMGUI_API   ImGuiIO();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2146
        pass
...
class InputTextCallbackData:  # imgui.h:2162
    ...
    event_flag: InputTextFlags  # One ImGuiInputTextFlags_Callback*    // Read-only    # imgui.h:2164
    # ImGuiInputTextFlags Flags;    /* original C++ signature */
    flags: InputTextFlags  # What user passed to InputText()      // Read-only    # imgui.h:2165
    # void*               UserData;    /* original C++ signature */
    user_data: Any  # What user passed to InputText()      // Read-only    # imgui.h:2166
    ...
    event_char: ImWchar  # Character input                      // Read-write   // [CharFilter] Replace character with another one, or set to zero to drop. return 1 is equivalent to setting EventChar=0;    # imgui.h:2171
    # ImGuiKey            EventKey;    /* original C++ signature */
    event_key: Key  # Key pressed (Up/Down/TAB)            // Read-only    // [Completion,History]    # imgui.h:2172
    # int                 BufTextLen;    /* original C++ signature */
    buf_text_len: int  # Text length (in bytes)               // Read-write   // [Resize,Completion,History,Always] Exclude zero-terminator storage. In C land: == strlen(some_text), in C++ land: string.length()    # imgui.h:2174
    # int                 BufSize;    /* original C++ signature */
    buf_size: int  # Buffer size (in bytes) = capacity+1  // Read-only    // [Resize,Completion,History,Always] Include zero-terminator storage. In C land == ARRAYSIZE(my_char_array), in C++ land: string.capacity()+1    # imgui.h:2175
    # bool                BufDirty;    /* original C++ signature */
    buf_dirty: bool  # Set if you modify Buf/BufTextLen!    // Write        // [Completion,History,Always]    # imgui.h:2176
    # int                 CursorPos;    /* original C++ signature */
    cursor_pos: int  #                                      // Read-write   // [Completion,History,Always]    # imgui.h:2177
    # int                 SelectionStart;    /* original C++ signature */
    selection_start: int  #                                      // Read-write   // [Completion,History,Always] == to SelectionEnd when no selection)    # imgui.h:2178
    # int                 SelectionEnd;    /* original C++ signature */
    selection_end: int  #                                      // Read-write   // [Completion,History,Always]    # imgui.h:2179

    # Helper functions for text manipulation.
    # Use those function to benefit from the CallbackResize behaviors. Calling those function reset the selection.
    # IMGUI_API ImGuiInputTextCallbackData();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2183
        pass
    # IMGUI_API void      DeleteChars(int pos, int bytes_count);    /* original C++ signature */
    def delete_chars(self, pos: int, bytes_count: int) -> None:  # imgui.h:2184
        pass
...
class SizeCallbackData:  # imgui.h:2193
    """Resizing callback data to apply custom constraint. As enabled by SetNextWindowSizeConstraints(). Callback is called during the next Begin().
    NB: For basic min/max size constraint on each axis you don't need to use the callback! The SetNextWindowSizeConstraints() parameters are enough.
    """

    # void*   UserData;    /* original C++ signature */
    user_data: Any  # Read-only.   What user passed to SetNextWindowSizeConstraints(). Generally store an integer or float in here (need reinterpret_cast<>).    # imgui.h:2195
    # ImVec2  Pos;    /* original C++ signature */
    pos: ImVec2  # Read-only.   Window position, for reference.    # imgui.h:2196
    # ImVec2  CurrentSize;    /* original C++ signature */
    current_size: ImVec2  # Read-only.   Current window size.    # imgui.h:2197
    # ImVec2  DesiredSize;    /* original C++ signature */
    desired_size: ImVec2  # Read-write.  Desired size, based on user's mouse position. Write to this field to restrain resizing.    # imgui.h:2198
...
class WindowClass:  # imgui.h:2208
    ...
    class_id: ID  # User data. 0 = Default class (unclassed). Windows of different classes cannot be docked with each others.    # imgui.h:2210
    ...
    viewport_flags_override_set: ViewportFlags  # Viewport flags to set when a window of this class owns a viewport. This allows you to enforce OS decoration or task bar icon, override the defaults on a per-window basis.    # imgui.h:2212
    # ImGuiViewportFlags  ViewportFlagsOverrideClear;    /* original C++ signature */
    viewport_flags_override_clear: ViewportFlags  # Viewport flags to clear when a window of this class owns a viewport. This allows you to enforce OS decoration or task bar icon, override the defaults on a per-window basis.    # imgui.h:2213
    # ImGuiTabItemFlags   TabItemFlagsOverrideSet;    /* original C++ signature */
    tab_item_flags_override_set: TabItemFlags  # [EXPERIMENTAL] TabItem flags to set when a window of this class gets submitted into a dock node tab bar. May use with ImGuiTabItemFlags_Leading or ImGuiTabItemFlags_Trailing.    # imgui.h:2214
    # ImGuiDockNodeFlags  DockNodeFlagsOverrideSet;    /* original C++ signature */
    dock_node_flags_override_set: DockNodeFlags  # [EXPERIMENTAL] Dock node flags to set when a window of this class is hosted by a dock node (it doesn't have to be selected!)    # imgui.h:2215
    # bool                DockingAlwaysTabBar;    /* original C++ signature */
    docking_always_tab_bar: bool  # Set to True to enforce single floating windows of this class always having their own docking node (equivalent of setting the global io.ConfigDockingAlwaysTabBar)    # imgui.h:2216
    # bool                DockingAllowUnclassed;    /* original C++ signature */
    docking_allow_unclassed: bool  # Set to True to allow windows of this class to be docked/merged with an unclassed window. // FIXME-DOCK: Move to DockNodeFlags override?    # imgui.h:2217

    # ImGuiWindowClass() { memset(this, 0, sizeof(*this)); ParentViewportId = (ImGuiID)-1; DockingAllowUnclassed = true; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2219
        pass

class Payload:  # imgui.h:2223
    """Data payload for Drag and Drop operations: AcceptDragDropPayload(), GetDragDropPayload()"""

    # Members
    # void*           Data;    /* original C++ signature */
    data: Any  # Data (copied and owned by dear imgui)    # imgui.h:2226
    # int             DataSize;    /* original C++ signature */
    data_size: int  # Data size    # imgui.h:2227

    # [Internal]
    # ImGuiID         SourceId;    /* original C++ signature */
    source_id: ID  # Source item id    # imgui.h:2230
    # ImGuiID         SourceParentId;    /* original C++ signature */
    source_parent_id: ID  # Source parent id (if available)    # imgui.h:2231
    # int             DataFrameCount;    /* original C++ signature */
    data_frame_count: int  # Data timestamp    # imgui.h:2232
    # bool            Preview;    /* original C++ signature */
    preview: bool  # Set when AcceptDragDropPayload() was called and mouse has been hovering the target item (nb: handle overlapping drag targets)    # imgui.h:2234
    # bool            Delivery;    /* original C++ signature */
    delivery: bool  # Set when AcceptDragDropPayload() was called and mouse button is released over the target item.    # imgui.h:2235

    # ImGuiPayload()  { Clear(); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2237
        pass

class TableColumnSortSpecs:  # imgui.h:2245
    """Sorting specification for one column of a table (sizeof == 12 bytes)"""

    # ImGuiID                     ColumnUserID;    /* original C++ signature */
    column_user_id: ID  # User id of the column (if specified by a TableSetupColumn() call)    # imgui.h:2247
    # ImS16                       ColumnIndex;    /* original C++ signature */
    column_index: ImS16  # Index of the column    # imgui.h:2248
    # ImS16                       SortOrder;    /* original C++ signature */
    sort_order: ImS16  # Index within parent ImGuiTableSortSpecs (always stored in order starting from 0, tables sorted on a single criteria will always have a 0 here)    # imgui.h:2249

    # ImGuiTableColumnSortSpecs() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2252
        pass

class TableSortSpecs:  # imgui.h:2259
    ...
    specs: TableColumnSortSpecs  # Pointer to sort spec array.    # imgui.h:2261
    # int                         SpecsCount;    /* original C++ signature */
    specs_count: int  # Sort spec count. Most often 1. May be > 1 when ImGuiTableFlags_SortMulti is enabled. May be == 0 when ImGuiTableFlags_SortTristate is enabled.    # imgui.h:2262
    # bool                        SpecsDirty;    /* original C++ signature */
    specs_dirty: bool  # Set to True when specs have changed since last time! Use this to sort again, then clear the flag.    # imgui.h:2263

    # ImGuiTableSortSpecs()       { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2265
        pass
...
class TextFilter:  # imgui.h:2290
    ...
    def __init__(self, default_filter: str = "") -> None:  # imgui.h:2292
        pass
    ...
    def build(self) -> None:  # imgui.h:2295
        pass

    class TextRange:  # imgui.h:2300
        """[Internal]"""
        ...
        def __init__(self) -> None:  # imgui.h:2305
            pass
        # ImGuiTextRange(const char* _b, const char* _e)  { b = _b; e = _e; }    /* original C++ signature */
        def __init__(self, _b: str, _e: str) -> None:  # imgui.h:2306
            pass
    # int                     CountGrep;    /* original C++ signature */
    count_grep: int  # imgui.h:2312

class TextBuffer:  # imgui.h:2317
    """Helper: Growable text buffer for logging/accumulating text
    (this could be called 'ImGuiTextBuilder' / 'ImGuiStringBuilder')
    """

    # ImGuiTextBuffer()   { }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2322
        pass
    # IMGUI_API void      append(const char* str, const char* str_end = NULL);    /* original C++ signature */
    def append(self, str: str, str_end: Optional[str] = None) -> None:  # imgui.h:2331
        pass
    # IMGUI_API void      appendf(const char* fmt, ...) ;    /* original C++ signature */
    def appendf(self, fmt: str) -> None:  # imgui.h:2332
        pass

class Storage:  # imgui.h:2344
    ...
    def get_int_ref(self, key: ID, default_val: int = 0) -> int:  # imgui.h:2375
        pass
    # IMGUI_API bool*     GetBoolRef(ImGuiID key, bool default_val = false);    /* original C++ signature */
    def get_bool_ref(self, key: ID, default_val: bool = False) -> bool:  # imgui.h:2376
        pass
    # IMGUI_API float*    GetFloatRef(ImGuiID key, float default_val = 0.0f);    /* original C++ signature */
    def get_float_ref(self, key: ID, default_val: float = 0.0) -> float:  # imgui.h:2377
        pass
    # IMGUI_API void      SetAllInt(int val);    /* original C++ signature */
    def set_all_int(self, val: int) -> None:  # imgui.h:2381
        """Use on your own storage if you know only integer are being stored (open/close all tree nodes)"""
        pass
    # IMGUI_API void      BuildSortByKey();    /* original C++ signature */
    def build_sort_by_key(self) -> None:  # imgui.h:2384
...
class ListClipper:  # imgui.h:2407
    ...
    display_start: int  # First item to display, updated by each call to Step()    # imgui.h:2409
    # int             DisplayEnd;    /* original C++ signature */
    display_end: int  # End of items to display (exclusive)    # imgui.h:2410
    # int             ItemsCount;    /* original C++ signature */
    items_count: int  # [Internal] Number of items    # imgui.h:2411
    # float           ItemsHeight;    /* original C++ signature */
    items_height: float  # [Internal] Height of item after a first step and item submission can calculate it    # imgui.h:2412
    # float           StartPosY;    /* original C++ signature */
    start_pos_y: float  # [Internal] Cursor position at the time of Begin() or after table frozen rows are all processed    # imgui.h:2413
    # void*           TempData;    /* original C++ signature */
    temp_data: Any  # [Internal] Internal data    # imgui.h:2414

    # IMGUI_API ImGuiListClipper();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2418
    ...
    def begin(
        ...
        pass
    # IMGUI_API void  End();                 /* original C++ signature */
    def end(self) -> None:  # imgui.h:2421
        """Automatically called on the last call of Step() that returns False."""
        pass
    # IMGUI_API bool  Step();                /* original C++ signature */
    def step(self) -> bool:  # imgui.h:2422
...
class ImColor:  # imgui.h:2458
    ...
    **None of the ImGui API are using ImColor directly but you can use it as a convenience to pass colors in either ImU32 or ImVec4 formats. Explicitly cast to ImU32 or ImVec4 if needed.
    ...
    value: ImVec4  # imgui.h:2460

    # constexpr ImColor()                                             { }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2462
        pass
    ...
    def __init__(self, col: ImVec4) -> None:  # imgui.h:2464
        pass
    ...
    def __init__(self, r: int, g: int, b: int, a: int = 255) -> None:  # imgui.h:2465
        pass
    ...
    def __init__(self, rgba: ImU32) -> None:  # imgui.h:2466
        pass
...
class ImDrawCmd:  # imgui.h:2507
    ...
    clip_rect: ImVec4  # 4*4  // Clipping rectangle (x1, y1, x2, y2). Subtract ImDrawData->DisplayPos to get clipping rectangle in "viewport" coordinates    # imgui.h:2509
    # ImTextureID     TextureId;    /* original C++ signature */
    texture_id: ImTextureID  # 4-8  // User-provided texture ID. Set by user in ImfontAtlas::SetTexID() for fonts or passed to Image*() functions. Ignore if never using images or multiple fonts atlas.    # imgui.h:2510
    # unsigned int    VtxOffset;    /* original C++ signature */
    vtx_offset: int  # 4    // Start offset in vertex buffer. ImGuiBackendFlags_RendererHasVtxOffset: always 0, otherwise may be >0 to support meshes larger than 64K vertices with 16-bit indices.    # imgui.h:2511
    # unsigned int    IdxOffset;    /* original C++ signature */
    idx_offset: int  # 4    // Start offset in index buffer.    # imgui.h:2512
    # unsigned int    ElemCount;    /* original C++ signature */
    elem_count: int  # 4    // Number of indices (multiple of 3) to be rendered as triangles. Vertices are stored in the callee ImDrawList's vtx_buffer[] array, indices in idx_buffer[].    # imgui.h:2513
    # void*           UserCallbackData;    /* original C++ signature */
    user_callback_data: Any  # 4-8  // The draw callback code can access this.    # imgui.h:2515

    # ImDrawCmd() { memset(this, 0, sizeof(*this)); }     /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2517
        """Also ensure our padding fields are zeroed"""
        pass

# Vertex layout

class ImDrawCmdHeader:  # imgui.h:2540
    """[Internal] For use by ImDrawList"""

    # ImVec4          ClipRect;    /* original C++ signature */
    clip_rect: ImVec4  # imgui.h:2542
    # ImTextureID     TextureId;    /* original C++ signature */
    texture_id: ImTextureID  # imgui.h:2543
    # unsigned int    VtxOffset;    /* original C++ signature */
...
class ImDrawChannel:  # imgui.h:2548
...
class ImDrawFlags_(enum.Enum):  # imgui.h:2574
...
class ImDrawListFlags_(enum.Enum):  # imgui.h:2594
...
class ImDrawList:  # imgui.h:2612
    ...
    flags: ImDrawListFlags  # Flags, you may poke into these to adjust anti-aliasing settings per-primitive.    # imgui.h:2618

    # [Internal, used while building lists]
    # unsigned int            _VtxCurrentIdx;    /* original C++ signature */
    _vtx_current_idx: int  # [Internal] generally == VtxBuffer.Size unless we are past 64K vertices, in which case this gets reset to 0.    # imgui.h:2621
    # ImDrawListSharedData*   _Data;    /* original C++ signature */
    _data: ImDrawListSharedData  # Pointer to shared draw data (you can use ImGui::GetDrawListSharedData() to get the one from current ImGui context)    # imgui.h:2622
    # const char*             _OwnerName;    /* original C++ signature */
    _owner_name: str  # Pointer to owner window's name for debugging    # imgui.h:2623
    # ImDrawVert*             _VtxWritePtr;    /* original C++ signature */
    _vtx_write_ptr: ImDrawVert  # [Internal] point within VtxBuffer.Data after each add command (to avoid using the ImVector<> operators too much)    # imgui.h:2624
    # ImDrawIdx*              _IdxWritePtr;    /* original C++ signature */
    _idx_write_ptr: ImDrawIdx  # [Internal] point within IdxBuffer.Data after each add command (to avoid using the ImVector<> operators too much)    # imgui.h:2625
    # ImDrawCmdHeader         _CmdHeader;    /* original C++ signature */
    _cmd_header: ImDrawCmdHeader  # [Internal] template of active commands. Fields should match those of CmdBuffer.back().    # imgui.h:2629
    # ImDrawListSplitter      _Splitter;    /* original C++ signature */
    _splitter: ImDrawListSplitter  # [Internal] for channels api (note: prefer using your own persistent instance of ImDrawListSplitter!)    # imgui.h:2630
    # float                   _FringeScale;    /* original C++ signature */
    _fringe_scale: float  # [Internal] anti-alias fringe is scaled by this value, this helps to keep things sharp while zooming at vertex buffer content    # imgui.h:2631

    # ImDrawList(ImDrawListSharedData* shared_data) { memset(this, 0, sizeof(*this)); _Data = shared_data; }    /* original C++ signature */
    def __init__(self, shared_data: ImDrawListSharedData) -> None:  # imgui.h:2634
    ...
    def push_clip_rect_full_screen(self) -> None:  # imgui.h:2638
        pass
    # IMGUI_API void  PopClipRect();    /* original C++ signature */
    def pop_clip_rect(self) -> None:  # imgui.h:2639
        pass
    # IMGUI_API void  PushTextureID(ImTextureID texture_id);    /* original C++ signature */
    def push_texture_id(self, texture_id: ImTextureID) -> None:  # imgui.h:2640
        pass
    # IMGUI_API void  PopTextureID();    /* original C++ signature */
    def pop_texture_id(self) -> None:  # imgui.h:2641
        pass
    # Primitives
    ...
    def prim_reserve(self, idx_count: int, vtx_count: int) -> None:  # imgui.h:2710
        pass
    # IMGUI_API void  PrimUnreserve(int idx_count, int vtx_count);    /* original C++ signature */
    def prim_unreserve(self, idx_count: int, vtx_count: int) -> None:  # imgui.h:2711
        pass
    # IMGUI_API void  PrimRect(const ImVec2& a, const ImVec2& b, ImU32 col);          /* original C++ signature */
    def prim_rect(self, a: ImVec2, b: ImVec2, col: ImU32) -> None:  # imgui.h:2712
...
class ImDrawData:  # imgui.h:2740
    ...
    valid: bool  # Only valid after Render() is called and before the next NewFrame() is called.    # imgui.h:2742
    # int             CmdListsCount;    /* original C++ signature */
    cmd_lists_count: int  # Number of ImDrawList* to render    # imgui.h:2743
    # int             TotalIdxCount;    /* original C++ signature */
    total_idx_count: int  # For convenience, sum of all ImDrawList's IdxBuffer.Size    # imgui.h:2744
    # int             TotalVtxCount;    /* original C++ signature */
    total_vtx_count: int  # For convenience, sum of all ImDrawList's VtxBuffer.Size    # imgui.h:2745
    # ImVec2          DisplayPos;    /* original C++ signature */
    display_pos: ImVec2  # Top-left position of the viewport to render (== top-left of the orthogonal projection matrix to use) (== GetMainViewport()->Pos for the main viewport, == (0.0) in most single-viewport applications)    # imgui.h:2747
    # ImVec2          DisplaySize;    /* original C++ signature */
    display_size: ImVec2  # Size of the viewport to render (== GetMainViewport()->Size for the main viewport, == io.DisplaySize in most single-viewport applications)    # imgui.h:2748
    # ImVec2          FramebufferScale;    /* original C++ signature */
    framebuffer_scale: ImVec2  # Amount of pixels for each unit of DisplaySize. Based on io.DisplayFramebufferScale. Generally (1,1) on normal display, (2,2) on OSX with Retina display.    # imgui.h:2749
    # ImGuiViewport*  OwnerViewport;    /* original C++ signature */
    owner_viewport: Viewport  # Viewport carrying the ImDrawData instance, might be of use to the renderer (generally not).    # imgui.h:2750

    # ImDrawData()    { Clear(); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2753
        """Functions"""
        pass
    # IMGUI_API void  DeIndexAllBuffers();                        /* original C++ signature */
    def de_index_all_buffers(self) -> None:  # imgui.h:2755
        """Helper to convert all buffers from indexed to non-indexed, in case you cannot render indexed. Note: this is slow and most likely a waste of resources. Always prefer indexed rendering!"""
        pass
    # IMGUI_API void  ScaleClipRects(const ImVec2& fb_scale);     /* original C++ signature */
    def scale_clip_rects(self, fb_scale: ImVec2) -> None:  # imgui.h:2756
...
class ImFontConfig:  # imgui.h:2763
    # void*           FontData;    /* original C++ signature */
    font_data: Any  #          // TTF/OTF data    # imgui.h:2765
    # int             FontDataSize;    /* original C++ signature */
    font_data_size: int  #          // TTF/OTF data size    # imgui.h:2766
    # bool            FontDataOwnedByAtlas;    /* original C++ signature */
    font_data_owned_by_atlas: bool  # True     // TTF/OTF data ownership taken by the container ImFontAtlas (will delete memory itself).    # imgui.h:2767
    # int             FontNo;    /* original C++ signature */
    font_no: int  # 0        // Index of font within TTF/OTF file    # imgui.h:2768
    # float           SizePixels;    /* original C++ signature */
    size_pixels: float  #          // Size in pixels for rasterizer (more or less maps to the resulting font height).    # imgui.h:2769
    # int             OversampleH;    /* original C++ signature */
    oversample_h: int  # 3        // Rasterize at higher quality for sub-pixel positioning. Note the difference between 2 and 3 is minimal so you can reduce this to 2 to save memory. Read https://github.com/nothings/stb/blob/master/tests/oversample/README.md for details.    # imgui.h:2770
    # int             OversampleV;    /* original C++ signature */
    oversample_v: int  # 1        // Rasterize at higher quality for sub-pixel positioning. This is not really useful as we don't use sub-pixel positions on the Y axis.    # imgui.h:2771
    # bool            PixelSnapH;    /* original C++ signature */
    pixel_snap_h: bool  # False    // Align every glyph to pixel boundary. Useful e.g. if you are merging a non-pixel aligned font with the default font. If enabled, you can set OversampleH/V to 1.    # imgui.h:2772
    # ImVec2          GlyphExtraSpacing;    /* original C++ signature */
    glyph_extra_spacing: ImVec2  # 0, 0     // Extra spacing (in pixels) between glyphs. Only X axis is supported for now.    # imgui.h:2773
    # ImVec2          GlyphOffset;    /* original C++ signature */
    glyph_offset: ImVec2  # 0, 0     // Offset all glyphs from this font input.    # imgui.h:2774
    # float           GlyphMinAdvanceX;    /* original C++ signature */
    glyph_min_advance_x: float  # 0        // Minimum AdvanceX for glyphs, set Min to align font icons, set both Min/Max to enforce mono-space font    # imgui.h:2776
    # float           GlyphMaxAdvanceX;    /* original C++ signature */
    glyph_max_advance_x: float  # FLT_MAX  // Maximum AdvanceX for glyphs    # imgui.h:2777
    # bool            MergeMode;    /* original C++ signature */
    merge_mode: bool  # False    // Merge into previous ImFont, so you can combine multiple inputs font into one ImFont (e.g. ASCII font + icons + Japanese glyphs). You may want to use GlyphOffset.y when merge font of different heights.    # imgui.h:2778
    # unsigned int    FontBuilderFlags;    /* original C++ signature */
    font_builder_flags: int  # 0        // Settings for custom font builder. THIS IS BUILDER IMPLEMENTATION DEPENDENT. Leave as zero if unsure.    # imgui.h:2779
    # float           RasterizerMultiply;    /* original C++ signature */
    rasterizer_multiply: float  # 1.0     // Brighten (>1.0) or darken (<1.0) font output. Brightening small fonts may be a good workaround to make them more readable.    # imgui.h:2780
    # ImWchar         EllipsisChar;    /* original C++ signature */
    ellipsis_char: ImWchar  # -1       // Explicitly specify unicode codepoint of ellipsis character. When fonts are being merged first specified ellipsis will be used.    # imgui.h:2781

    # [Internal]
    # ImFont*         DstFont;    /* original C++ signature */
    dst_font: ImFont  # imgui.h:2785

    # IMGUI_API ImFontConfig();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2787
        pass

class ImFontGlyph:  # imgui.h:2792
    """Hold rendering data for one glyph.
    (Note: some language parsers may fail to convert the 31+1 bitfield members, in this case maybe drop store a single u32 or we can rework this)
    """

    # float           AdvanceX;    /* original C++ signature */
    advance_x: float  # Distance to next character (= data from font + ImFontConfig::GlyphExtraSpacing.x baked in)    # imgui.h:2797
    # float           X0,     /* original C++ signature */
    x0: float  # Glyph corners    # imgui.h:2798
    # Y0,     /* original C++ signature */
    y0: float  # Glyph corners    # imgui.h:2798
    # X1,     /* original C++ signature */
    x1: float  # Glyph corners    # imgui.h:2798
    # Y1;    /* original C++ signature */
    y1: float  # Glyph corners    # imgui.h:2798
    # float           U0,     /* original C++ signature */
    u0: float  # Texture coordinates    # imgui.h:2799
    # V0,     /* original C++ signature */
    v0: float  # Texture coordinates    # imgui.h:2799
    # U1,     /* original C++ signature */
    u1: float  # Texture coordinates    # imgui.h:2799
    # V1;    /* original C++ signature */
    v1: float  # Texture coordinates    # imgui.h:2799
...
class ImFontGlyphRangesBuilder:  # imgui.h:2804
    ...
    def add_ranges(self, ranges: ImWchar) -> None:  # imgui.h:2814
        """Add ranges, e.g. builder.AddRanges(ImFontAtlas::GetGlyphRangesDefault()) to force add all of ASCII/Latin+Ext"""
        pass
    # IMGUI_API void  BuildRanges(ImVector<ImWchar>* out_ranges);                     /* original C++ signature */
    def build_ranges(self, out_ranges: List[ImWchar]) -> None:  # imgui.h:2815
        """Output new ranges"""
        pass

class ImFontAtlasCustomRect:  # imgui.h:2819
    """See ImFontAtlas::AddCustomRectXXX functions."""

    # unsigned short  Width,     /* original C++ signature */
    width: int  # Input    // Desired rectangle dimension    # imgui.h:2821
    # Height;    /* original C++ signature */
    height: int  # Input    // Desired rectangle dimension    # imgui.h:2821
    # unsigned short  X,     /* original C++ signature */
    x: int  # Output   // Packed position in Atlas    # imgui.h:2822
    # Y;    /* original C++ signature */
    y: int  # Output   // Packed position in Atlas    # imgui.h:2822
    # unsigned int    GlyphID;    /* original C++ signature */
    glyph_id: int  # Input    // For custom font glyphs only (ID < 0x110000)    # imgui.h:2823
    # float           GlyphAdvanceX;    /* original C++ signature */
    glyph_advance_x: float  # Input    // For custom font glyphs only: glyph xadvance    # imgui.h:2824
    # ImVec2          GlyphOffset;    /* original C++ signature */
    glyph_offset: ImVec2  # Input    // For custom font glyphs only: glyph display offset    # imgui.h:2825
    # ImFont*         Font;    /* original C++ signature */
    font: ImFont  # Input    // For custom font glyphs only: target font    # imgui.h:2826
    ...
    def __init__(self) -> None:  # imgui.h:2827
        pass

class ImFontAtlasFlags_(enum.Enum):  # imgui.h:2832
...
class ImFontAtlas:  # imgui.h:2857
    ...
    def __init__(self) -> None:  # imgui.h:2859
        pass
    # IMGUI_API ImFont*           AddFont(const ImFontConfig* font_cfg);    /* original C++ signature */
    def add_font(self, font_cfg: ImFontConfig) -> ImFont:  # imgui.h:2861
        pass
    ...
    def build(self) -> bool:  # imgui.h:2877
    ...
    def add_custom_rect_regular(self, width: int, height: int) -> int:  # imgui.h:2911
        pass
    ...
    flags: ImFontAtlasFlags  # Build flags (see ImFontAtlasFlags_)    # imgui.h:2923
    # ImTextureID                 TexID;    /* original C++ signature */
    tex_id: ImTextureID  # User data to refer to the texture once it has been uploaded to user's graphic systems. It is passed back to you during rendering via the ImDrawCmd structure.    # imgui.h:2924
    # int                         TexDesiredWidth;    /* original C++ signature */
    tex_desired_width: int  # Texture width desired by user before Build(). Must be a power-of-two. If have many glyphs your graphics API have texture size restrictions you may want to increase texture width to decrease height.    # imgui.h:2925
    # int                         TexGlyphPadding;    /* original C++ signature */
    tex_glyph_padding: int  # Padding between glyphs within texture in pixels. Defaults to 1. If your rendering method doesn't rely on bilinear filtering you may set this to 0 (will also need to set AntiAliasedLinesUseTex = False).    # imgui.h:2926
    # bool                        Locked;    /* original C++ signature */
    locked: bool  # Marked as Locked by ImGui::NewFrame() so attempt to modify the atlas will assert.    # imgui.h:2927

    # [Internal]
    # NB: Access texture data via GetTexData*() calls! Which will setup a default font for you.
    # bool                        TexReady;    /* original C++ signature */
    tex_ready: bool  # Set when texture was built matching current font input    # imgui.h:2931
    # bool                        TexPixelsUseColors;    /* original C++ signature */
    tex_pixels_use_colors: bool  # Tell whether our texture data is known to use colors (rather than just alpha channel), in order to help backend select a format.    # imgui.h:2932
    # int                         TexWidth;    /* original C++ signature */
    tex_width: int  # Texture width calculated during Build().    # imgui.h:2935
    # int                         TexHeight;    /* original C++ signature */
    tex_height: int  # Texture height calculated during Build().    # imgui.h:2936
    # ImVec2                      TexUvScale;    /* original C++ signature */
    tex_uv_scale: ImVec2  # = (1.0/TexWidth, 1.0/TexHeight)    # imgui.h:2937
    # ImVec2                      TexUvWhitePixel;    /* original C++ signature */
    tex_uv_white_pixel: ImVec2  # Texture coordinates to a white pixel    # imgui.h:2938

    # [Internal] Font builder
    # const ImFontBuilderIO*      FontBuilderIO;    /* original C++ signature */
    font_builder_io: ImFontBuilderIO  # Opaque interface to a font builder (default to stb_truetype, can be changed to use FreeType by defining IMGUI_ENABLE_FREETYPE).    # imgui.h:2945
    # unsigned int                FontBuilderFlags;    /* original C++ signature */
    font_builder_flags: int  # Shared flags (for all fonts) for custom font builder. THIS IS BUILD IMPLEMENTATION DEPENDENT. Per-font override is also available in ImFontConfig.    # imgui.h:2946

    # [Internal] Packing data
    # int                         PackIdMouseCursors;    /* original C++ signature */
    pack_id_mouse_cursors: int  # Custom texture rectangle ID for white pixel and mouse cursors    # imgui.h:2949
    # int                         PackIdLines;    /* original C++ signature */
    pack_id_lines: int  # Custom texture rectangle ID for baked anti-aliased lines    # imgui.h:2950

    # [Obsolete]
    # typedef ImFontAtlasCustomRect    CustomRect;         // OBSOLETED in 1.72+
    # typedef ImFontGlyphRangesBuilder GlyphRangesBuilder; // OBSOLETED in 1.67+

class ImFont:  # imgui.h:2959
    ...
    fallback_advance_x: float  # 4     // out // = FallbackGlyph->AdvanceX    # imgui.h:2963
    # float                       FontSize;    /* original C++ signature */
    font_size: float  # 4     // in  //            // Height of characters/line, set during loading (don't change after loading)    # imgui.h:2964

    # Members: Hot ~28/40 bytes (for CalcTextSize + render loop)
    # const ImFontGlyph*          FallbackGlyph;    /* original C++ signature */
    fallback_glyph: ImFontGlyph  # 4-8   // out // = FindGlyph(FontFallbackChar)    # imgui.h:2969

    # Members: Cold ~32/40 bytes
    # ImFontAtlas*                ContainerAtlas;    /* original C++ signature */
    container_atlas: ImFontAtlas  # 4-8   // out //            // What we has been loaded into    # imgui.h:2972
    # const ImFontConfig*         ConfigData;    /* original C++ signature */
    config_data: ImFontConfig  # 4-8   // in  //            // Pointer within ContainerAtlas->ConfigData    # imgui.h:2973
    # short                       ConfigDataCount;    /* original C++ signature */
    config_data_count: int  # 2     // in  // ~ 1        // Number of ImFontConfig involved in creating this font. Bigger than 1 when merging multiple font sources into one ImFont.    # imgui.h:2974
    # ImWchar                     FallbackChar;    /* original C++ signature */
    fallback_char: ImWchar  # 2     // out // = FFFD/'?' // Character used if a glyph isn't found.    # imgui.h:2975
    # ImWchar                     EllipsisChar;    /* original C++ signature */
    ellipsis_char: ImWchar  # 2     // out // = '...'    // Character used for ellipsis rendering.    # imgui.h:2976
    # ImWchar                     DotChar;    /* original C++ signature */
    dot_char: ImWchar  # 2     // out // = '.'      // Character used for ellipsis rendering (if a single '...' character isn't found)    # imgui.h:2977
    # bool                        DirtyLookupTables;    /* original C++ signature */
    dirty_lookup_tables: bool  # 1     // out //    # imgui.h:2978
    # float                       Scale;    /* original C++ signature */
    scale: float  # 4     // in  // = 1.      // Base font scale, multiplied by the per-window font scale which you can adjust with SetWindowFontScale()    # imgui.h:2979
    # float                       Ascent,     /* original C++ signature */
    ascent: float  # 4+4   // out //            // Ascent: distance from top to bottom of e.g. 'A' [0..FontSize]    # imgui.h:2980
    # Descent;    /* original C++ signature */
    descent: float  # 4+4   // out //            // Ascent: distance from top to bottom of e.g. 'A' [0..FontSize]    # imgui.h:2980
    # int                         MetricsTotalSurface;    /* original C++ signature */
    metrics_total_surface: int  # 4     // out //            // Total surface in pixels to get an idea of the font rasterization/texture cost (not exact, we approximate the cost of padding between glyphs)    # imgui.h:2981

    # IMGUI_API ImFont();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2985
        """Methods"""
        pass
    # IMGUI_API const ImFontGlyph*FindGlyph(ImWchar c) const;    /* original C++ signature */
    def find_glyph(self, c: ImWchar) -> ImFontGlyph:  # imgui.h:2987
        pass
    # IMGUI_API const ImFontGlyph*FindGlyphNoFallback(ImWchar c) const;    /* original C++ signature */
    def find_glyph_no_fallback(self, c: ImWchar) -> ImFontGlyph:  # imgui.h:2988
        pass
    ...
    def build_lookup_table(self) -> None:  # imgui.h:3001
        pass
    # IMGUI_API void              ClearOutputData();    /* original C++ signature */
    def clear_output_data(self) -> None:  # imgui.h:3002
        pass
    # IMGUI_API void              GrowIndex(int new_size);    /* original C++ signature */
    def grow_index(self, new_size: int) -> None:  # imgui.h:3003
        pass
    ...
    def set_glyph_visible(self, c: ImWchar, visible: bool) -> None:  # imgui.h:3006
        pass
    # IMGUI_API bool              IsGlyphRangeUnused(unsigned int c_begin, unsigned int c_last);    /* original C++ signature */
    def is_glyph_range_unused(self, c_begin: int, c_last: int) -> bool:  # imgui.h:3007
        pass
...
class ViewportFlags_(enum.Enum):  # imgui.h:3015
    ...
    minimized = (
        enum.auto()
    )  # (= 1 << 10)  # Platform Window: Window is minimized, can skip render. When minimized we tend to avoid using the viewport pos/size for clipping window or testing if they are contained in the viewport.
    # ImGuiViewportFlags_NoAutoMerge              = 1 << 11,      /* original C++ signature */
    no_auto_merge = (
        enum.auto()
    )  # (= 1 << 11)  # Platform Window: Avoid merging this window into another host window. This can only be set via ImGuiWindowClass viewport flags override (because we need to now ahead if we are going to create a viewport in the first place!).
...
class Viewport:  # imgui.h:3040
    ...
    id_: ID  # Unique identifier for the viewport    # imgui.h:3042
    # ImGuiViewportFlags  Flags;    /* original C++ signature */
    flags: ViewportFlags  # See ImGuiViewportFlags_    # imgui.h:3043
    # ImVec2              Pos;    /* original C++ signature */
    pos: ImVec2  # Main Area: Position of the viewport (Dear ImGui coordinates are the same as OS desktop/native coordinates)    # imgui.h:3044
    # ImVec2              Size;    /* original C++ signature */
    size: ImVec2  # Main Area: Size of the viewport.    # imgui.h:3045
    # ImVec2              WorkPos;    /* original C++ signature */
    work_pos: ImVec2  # Work Area: Position of the viewport minus task bars, menus bars, status bars (>= Pos)    # imgui.h:3046
    # ImVec2              WorkSize;    /* original C++ signature */
    work_size: ImVec2  # Work Area: Size of the viewport minus task bars, menu bars, status bars (<= Size)    # imgui.h:3047
    # float               DpiScale;    /* original C++ signature */
    dpi_scale: float  # 1.0 = 96 DPI = No extra scale.    # imgui.h:3048
    # ImGuiID             ParentViewportId;    /* original C++ signature */
    parent_viewport_id: ID  # (Advanced) 0: no parent. Instruct the platform backend to setup a parent/child relationship between platform windows.    # imgui.h:3049
    # ImDrawData*         DrawData;    /* original C++ signature */
    draw_data: ImDrawData  # The ImDrawData corresponding to this viewport. Valid after Render() and until the next call to NewFrame().    # imgui.h:3050
    ...
    renderer_user_data: Any  # None* to hold custom data structure for the renderer (e.g. swap chain, framebuffers etc.). generally set by your Renderer_CreateWindow function.    # imgui.h:3057
    # void*               PlatformUserData;    /* original C++ signature */
    platform_user_data: Any  # None* to hold custom data structure for the OS / platform (e.g. windowing info, render context). generally set by your Platform_CreateWindow function.    # imgui.h:3058
    # void*               PlatformHandle;    /* original C++ signature */
    platform_handle: Any  # None* for FindViewportByPlatformHandle(). (e.g. suggested to use natural platform handle such as HWND, GLFWWindow*, SDL_Window*)    # imgui.h:3059
    # void*               PlatformHandleRaw;    /* original C++ signature */
    platform_handle_raw: Any  # None* to hold lower-level, platform-native window handle (under Win32 this is expected to be a HWND, unused for other platforms), when using an abstraction layer like GLFW or SDL (where PlatformHandle would be a SDL_Window*)    # imgui.h:3060
    # bool                PlatformWindowCreated;    /* original C++ signature */
    platform_window_created: bool  # Platform window has been created (Platform_CreateWindow() has been called). This is False during the first frame where a viewport is being created.    # imgui.h:3061
    # bool                PlatformRequestMove;    /* original C++ signature */
    platform_request_move: bool  # Platform window requested move (e.g. window was moved by the OS / host window manager, authoritative position will be OS window position)    # imgui.h:3062
    # bool                PlatformRequestResize;    /* original C++ signature */
    platform_request_resize: bool  # Platform window requested resize (e.g. window was resized by the OS / host window manager, authoritative size will be OS window size)    # imgui.h:3063
    # bool                PlatformRequestClose;    /* original C++ signature */
    platform_request_close: bool  # Platform window requested closure (e.g. window was moved by the OS / host window manager, e.g. pressing ALT-F4)    # imgui.h:3064

    # ImGuiViewport()     { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:3066
        pass
    # Helpers
...
class PlatformIO:  # imgui.h:3124
    ...
    def __init__(self) -> None:  # imgui.h:3182
        """Zero clear"""
        pass

class PlatformMonitor:  # imgui.h:3187
    """(Optional) This is required when enabling multi-viewport. Represent the bounds of each connected monitor/display and their DPI.
    We use this information for multiple DPI support + clamping the position of popups and tooltips so they don't straddle multiple monitors.
    """

    # ImVec2  MainPos,     /* original C++ signature */
    main_pos: ImVec2  # Coordinates of the area displayed on this monitor (Min = upper left, Max = bottom right)    # imgui.h:3189
    # MainSize;    /* original C++ signature */
    main_size: ImVec2  # Coordinates of the area displayed on this monitor (Min = upper left, Max = bottom right)    # imgui.h:3189
    # ImVec2  WorkPos,     /* original C++ signature */
    work_pos: ImVec2  # Coordinates without task bars / side bars / menu bars. Used to avoid positioning popups/tooltips inside this region. If you don't have this info, please copy the value for MainPos/MainSize.    # imgui.h:3190
    # WorkSize;    /* original C++ signature */
    work_size: ImVec2  # Coordinates without task bars / side bars / menu bars. Used to avoid positioning popups/tooltips inside this region. If you don't have this info, please copy the value for MainPos/MainSize.    # imgui.h:3190
    # float   DpiScale;    /* original C++ signature */
    dpi_scale: float  # 1.0 = 96 DPI    # imgui.h:3191
    # ImGuiPlatformMonitor()          { MainPos = MainSize = WorkPos = WorkSize = ImVec2(0, 0); DpiScale = 1.0f; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:3192
        pass

class PlatformImeData:  # imgui.h:3196
    """(Optional) Support for IME (Input Method Editor) via the io.SetPlatformImeDataFn() function."""

    # bool    WantVisible;    /* original C++ signature */
    want_visible: bool  # A widget wants the IME to be visible    # imgui.h:3198
    # ImVec2  InputPos;    /* original C++ signature */
    input_pos: ImVec2  # Position of the input cursor    # imgui.h:3199
    # float   InputLineHeight;    /* original C++ signature */
    input_line_height: float  # Line height    # imgui.h:3200

    # ImGuiPlatformImeData() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:3202
        pass
